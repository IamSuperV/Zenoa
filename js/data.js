export const QUESTIONS_DB = [
    ...
    // LOGICAL EXPANSION
    {
        id: "log_ext_01",
        category: "Logical Intelligence",
        scenario: "You have a bucket of 100 blue marbles and 100 red marbles. You must divide them into two jars to maximize the chance of picking a blue marble if a jar is picked at random, then a marble.",
        options: [
            "50 blue/50 red in each.",
            "All blue in one, all red in the other.",
            "1 blue in one jar, all others in the second jar.",
            "Mix them thoroughly."
        ],
        weights: { "0": { logical: -2 }, "1": { logical: 1 }, "2": { logical: 3, strategic: 2 }, "3": { logical: -3 } }
    },
    {
        id: "log_ext_02",
        category: "Logical Intelligence",
        scenario: "A car averages 30 mph for the first half of a trip. How fast must it go for the second half to average 60 mph for the whole trip?",
        options: [
            "90 mph",
            "120 mph",
            "Infinite speed (Impossible)",
            "60 mph"
        ],
        weights: { "0": { logical: -2 }, "1": { logical: -2 }, "2": { logical: 3 }, "3": { logical: -3 } }
    },
    {
        id: "log_ext_03",
        category: "Logical Intelligence",
        scenario: "Two fathers and two sons go fishing. They catch one fish each. Total fish: 3. How?",
        options: [
            "One fish was lost.",
            "They are Grandfather, Father, and Son.",
            "One person didn't catch any, they lied.",
            "It's a math error."
        ],
    ...
    },
    {
        id: "log_ext_04",
        category: "Logical Intelligence",
        scenario: "A medical test is 99% accurate. 1 in 1000 people have the disease. You test positive. What is the chance you actually have it?",
        options: [
            "99%",
            "90%",
            "~50%",
        ...
        weights: { "0": { logical: -3 }, "1": { logical: -2 }, "2": { logical: -1 }, "3": { logical: 3 } }
    },
    {
        id: "log_ext_05",
        category: "Logical Intelligence",
        scenario: "Correlation is not Causation. Which is the best example?",
        options: [
            "Smoking causes cancer.",
            "Roosters crowing causes sunrise.",
    ...
    // STRATEGIC EXPANSION
    {
        id: "strat_ext_01",
        category: "Strategic Intelligence",
        scenario: "You are winning a war but your supply line is stretched. The enemy retreats into a fortress.",
        options: [
            "Siege the fortress immediately.",
            "Fake a retreat to lure them out.",
            "Burn their farms and wait.",
            "Negotiate peace."
        ],
        weights: { "0": { strategic: -2 }, "1": { strategic: 3, adaptive: 2 }, "2": { strategic: 1 }, "3": { strategic: 0 } }
    },
    {
        id: "strat_ext_02",
        category: "Strategic Intelligence",
        scenario: "Your product is perfect but boring. Competitor is flawed but viral.",
        options: [
            "Improve quality further.",
            "Create artificial controversy to go viral.",
            "Buy the competitor.",
            "Wait for their hype to die."
        ],
        weights: { "0": { strategic: -2 }, "1": { strategic: 2, political: 2 }, "2": { strategic: 3 }, "3": { strategic: -1 } }
    },
    {
        id: "strat_ext_03",
        category: "Strategic Intelligence",
        scenario: "A key employee demands equity or they leave to start a rival firm.",
        options: [
            "Give the equity.",
            "Let them leave and sue them later.",
            "Help them start the rival firm in exchange for partial ownership.",
            "Fire them immediately."
        ],
        weights: { "0": { strategic: 1 }, "1": { strategic: -2 }, "2": { strategic: 3, political: 2 }, "3": { strategic: -3 } }
    },
    {
        id: "strat_ext_04",
        category: "Strategic Intelligence",
        scenario: "You have information that the market will crash in 3 days. Warning everyone causes panic now.",
        options: [
            "Warn everyone immediately.",
            "Short the market and stay silent.",
            "Warn only your family.",
            "Do nothing."
        ],
        weights: { "0": { strategic: -2, social: 2 }, "1": { strategic: 3, social: -3 }, "2": { strategic: 1 }, "3": { strategic: 0 } }
    },
    {
        id: "strat_ext_05",
        category: "Strategic Intelligence",
        scenario: "In a negotiation, the other side offers exactly what you wanted immediately.",
        options: [
            "Accept it.",
            "Hesitate. You asked for too little.",
            "Ask for more.",
            "Sign but read the fine print twice."
        ],
        weights: { "0": { strategic: -1 }, "1": { strategic: 2 }, "2": { strategic: 1 }, "3": { strategic: 3 } }
    },
    ...
    // SOCIAL EXPANSION
    {
        id: "soc_ext_01",
        category: "Social Intelligence",
        scenario: "You forget a close friend's name while introducing them.",
        options: [
            "Admit it and laugh.",
            "Fake a cough.",
            "Ask the friend to introduce themselves.",
            "Guess."
        ],
        weights: { "0": { social: 3 }, "1": { social: -2 }, "2": { social: 2, strategic: 1 }, "3": { social: -3 } }
    },
    {
        id: "soc_ext_02",
        category: "Social Intelligence",
        scenario: "Someone is crying in a public bathroom stall.",
        options: [
            "Ask 'Are you okay?'.",
            "Leave them alone (privacy).",
            "Slide a tissue under the door.",
            "Find security."
        ],
        weights: { "0": { social: 2 }, "1": { social: 1 }, "2": { social: 3, adaptive: 1 }, "3": { social: -1 } }
    },
    {
        id: "soc_ext_03",
        category: "Social Intelligence",
        scenario: "A friend gives you a gift you hate. It was expensive.",
        options: [
            "Return it secretly.",
            "Tell them the truth gently.",
            "Wear/Use it only when they visit.",
            "Sell it."
        ],
        weights: { "0": { social: -1 }, "1": { social: 3 }, "2": { social: 2, political: 2 }, "3": { social: -3 } }
    },
    {
        id: "soc_ext_04",
        category: "Social Intelligence",
        scenario: "You hear a friend gossiping about you.",
        options: [
            "Walk in and say 'I heard that'.",
            "Listen to hear the full grievances.",
            "Ghost them forever.",
            "Gossip about them."
        ],
        weights: { "0": { social: 1, political: 1 }, "1": { social: 2, strategic: 2 }, "2": { social: -1 }, "3": { social: -2 } }
    },
    {
        id: "soc_ext_05",
        category: "Social Intelligence",
        scenario: "Waiter brings the wrong food. You are extremely hungry.",
        options: [
            "Eat it.",
            "Send it back politely.",
            "Yell at the waiter.",
            "Ask for it to be free."
        ],
        weights: { "0": { social: 1, adaptive: 2 }, "1": { social: 3 }, "2": { social: -3 }, "3": { social: -1 } }
    },
    ...
    // POLITICAL EXPANSION
    {
        id: "pol_ext_01",
        category: "Political Intelligence",
        scenario: "You are a king. A duke becomes too powerful but hasn't rebelled.",
        options: [
            "Kill him (Preemptive).",
        ...
        weights: { "0": { political: -1, strategic: -1 }, "1": { political: 3, strategic: 3 }, "2": { political: -2 }, "3": { political: 1 } }
    },
    {
        id: "pol_ext_02",
        category: "Political Intelligence",
        scenario: "A journalist asks a 'Gotcha' question on live TV.",
        options: [
            "Answer honestly.",
            "Attack the journalist.",
            "Pivot: 'That's not the real issue...'",
            "Walk out."
        ],
        weights: { "0": { political: -2 }, "1": { political: -3 }, "2": { political: 3 }, "3": { political: -2 } }
    },
    {
        id: "pol_ext_03",
        category: "Political Intelligence",
        scenario: "You control a resource everyone needs. People are starving.",
        options: [
            "Give it away for free.",
            "Sell it at market price.",
            "Sell it at 10x price.",
            "Ration it based on loyalty to you."
        ],
        weights: { "0": { political: -3, social: 3 }, "1": { political: 2 }, "2": { political: -2 }, "3": { political: 3, strategic: 2 } }
    },
    {
        id: "pol_ext_04",
        category: "Political Intelligence",
        scenario: "A law is unjust. You are a judge.",
        options: [
            "Enforce it. It's the law.",
            "Rule against it and risk being fired.",
            "Find a technicality to dismiss the case.",
            "Resign in protest."
        ],
        weights: { "0": { political: 1 }, "1": { political: 2, social: 2 }, "2": { political: 3, strategic: 3 }, "3": { political: 0 } }
    },
    {
        id: "pol_ext_05",
        category: "Political Intelligence",
        scenario: "Your ally commits a crime. You need their support for a bigger goal.",
        options: [
            "Turn them in.",
            "Cover it up.",
            "Distatnce yourself publicly.",
            "Blackmail them."
        ],
        weights: { "0": { political: -2, social: 2 }, "1": { political: 2, strategic: 1 }, "2": { political: 1 }, "3": { political: 2, strategic: 2 } }
    },
    ...
    // ADAPTIVE EXPANSION
    {
        id: "adt_ext_01",
        category: "Adaptive Intelligence",
        scenario: "You wake up in a forest with amnesia. You hear a wolf.",
        options: [
            "Climb a tree.",
            "Run.",
            "Look for a weapon.",
    ...
    },
    {
        id: "adt_ext_02",
        category: "Adaptive Intelligence",
        scenario: "The internet goes down globally. Forever.",
        options: [
            "Panic.",
            "Start a local newspaper.",
            "Become a farmer.",
            "Try to fix it."
        ],
        weights: { "0": { adaptive: -3 }, "1": { adaptive: 3, strategic: 2 }, "2": { adaptive: 2 }, "3": { adaptive: -2 } }
    },
    {
        id: "adt_ext_03",
        category: "Adaptive Intelligence",
        scenario: "You are given a task you cannot do. Deadline is 1 hour.",
        options: [
            "Struggle until deadline.",
            "Delegate immediately.",
            "Confess immediately and ask for help.",
            "Fake the result."
        ],
        weights: { "0": { adaptive: -2 }, "1": { adaptive: 2 }, "2": { adaptive: 3 }, "3": { adaptive: -1 } }
    },
    {
        id: "adt_ext_04",
        category: "Adaptive Intelligence",
        scenario: "Your house is burning. You can save one thing.",
        options: [
            "Laptop (Work).",
        ...
        weights: { "0": { adaptive: -1 }, "1": { adaptive: -1 }, "2": { adaptive: 3, social: 2 }, "3": { adaptive: 1 } }
    },
    {
        id: "adt_ext_05",
        category: "Adaptive Intelligence",
        scenario: "You are debating. You realize mid-sentence you are wrong.",
        options: [
            "Stop talking.",
            "Keep arguing to save face.",
            "Pivot the argument.",
            "Say 'Actually, looking at this differently...'"
        ],
        weights: { "0": { adaptive: -1 }, "1": { adaptive: -2 }, "2": { adaptive: 1 }, "3": { adaptive: 3, social: 2 } }
    }
];
